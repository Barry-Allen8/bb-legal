...
function baseSchema(locale) {
  return {
    ...
    "@graph": [
      { "@type": ["Organization", "LocalBusiness", "LegalService"], "@id": `${SITE.origin}/#organization`, name: SITE.name, url: SITE.origin, email: SITE.email, telephone: SITE.phoneHref, address: { "@type": "PostalAddress", streetAddress: "Gimnazjalna 2A/213", postalCode: "85-007", addressLocality: "Bydgoszcz", addressRegion: "kujawsko-pomorskie", addressCountry: "PL" }, areaServed: { "@type": "Country", name: "Poland" }, availableLanguage: ["pl", "uk", "ru", "en"] },
