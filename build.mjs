...
function footer(locale) {
  ...
  return `<footer class="site-footer"><div class="container footer-grid">
    <div class="footer-brand"><img class="footer-logo" src="/assets/bb-logo.png" width="104" height="104" alt="${siteNameHtml}"><p>${escapeHtml(ui.footerLead)}</p><address>${link(`tel:${SITE.phoneHref}`, SITE.phone)}${link(`tel:${SITE.phoneAltHref}`, `${SITE.phoneAlt} · Viber / WhatsApp`)}${link(`mailto:${SITE.email}`, SITE.email)}<span>${SITE.address}</span></address><div class="footer-social-links"><a href="${SITE.instagram}" target="_blank" rel="noopener noreferrer" class="footer-social-btn" aria-label="Instagram"><svg width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><rect x="2" y="2" width="20" height="20" rx="5" ry="5"/><path d="M16 11.37A4 4 0 1 1 12.63 8 4 4 0 0 1 16 11.37z"/><line x1="17.5" y1="6.5" x2="17.51" y2="6.5"/></svg><span>Instagram</span></a><a href="${SITE.facebook}" target="_blank" rel="noopener noreferrer" class="footer-social-btn" aria-label="Facebook"><svg width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M18 2h-3a5 5 0 0 0-5 5v3H7v4h3v8h4v-8h3l1-4h-4V7a1 1 0 0 1 1-1h3z"/></svg><span>Facebook</span></a></div></div>
